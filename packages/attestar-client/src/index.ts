...
export interface Client {
   ...
   */
  submit_attestation: ({epoch, proof, root, total_liabilities, fiat_reserves, fiat_sig}: {epoch: u64, proof: Proof, root: Buffer, total_liabilities: u128, fiat_reserves: u128, fiat_sig: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Attestation>>>
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAABAAAAAAAAAAAAAAABUVycm9yAAAAAAAABQAAAAAAAAAOTm90SW5pdGlhbGl6ZWQAAAAAAAEAAAAAAAAAEkFscmVhZHlJbml0aWFsaXplZAAAAAAAAgAAAAAAAAAOVmVyaWZpZXJOb3RTZXQAAAAAAAMAAAAAAAAADEludmFsaWRQcm9vZgAAAAQAAAAAAAAAC0Vwb2NoRXhpc3RzAAAAAAU=",
        ...
        "",
        "AAAAAAAAAAAAAAAGbGF0ZXN0AAAAAAAAAAAAAQAAA+gAAAfQAAAAC0F0dGVzdGF0aW9uAA==",
        "AAAABQAAAAAAAAAAAAAAEUF0dGVzdGF0aW9uUG9zdGVkAAAAAAAAAQAAABJhdHRlc3RhdGlvbl9wb3N0ZWQAAAAAAAQAAAAAAAAABWVwb2NoAAAAAAAABgAAAAEAAAAAAAAAB3NvbHZlbnQAAAAAAQAAAAAAAAAAAAAAEXRvdGFsX2xpYWJpbGl0aWVzAAAAAAAACgAAAAAAAAAAAAAAEG9uY2hhaW5fcmVzZXJ2ZXMAAAALAAAAAAAAAAI=",
        ...
        "",
